...
* Erlang - Prebuilt packages (17.5, 17.4, etc)
  * The full list of prebuilt packages can be found here: 
    * gigalixir-20, heroku-20 stacks: https://builds.hex.pm/builds/otp/ubuntu-20.04/builds.txt
    * heroku-22 or scalingo-22 stacks: https://builds.hex.pm/builds/otp/ubuntu-22.04/builds.txt
    * heroku-24 or scalingo-24 stacks: https://builds.hex.pm/builds/otp/ubuntu-22.04/builds.txt
